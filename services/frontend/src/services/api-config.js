...
const API_ENDPOINTS = {
  ...
  CATALOG: {
    BASE_URL: process.env.REACT_APP_CATALOG_API || 'http://localhost:3000',
  ...
  CART: {
    BASE_URL: process.env.REACT_APP_CART_API || 'http://localhost:5000',
    CARTS: '/api/carts',
  ...
  ORDER: {
    BASE_URL: process.env.REACT_APP_ORDER_API || 'http://localhost:8080',
    ORDERS: '/api/orders',
